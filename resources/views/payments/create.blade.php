...
<style>
    ...
    .order-summary p { margin-bottom: 0.4rem; font-size: 0.9rem; color: #aca5db; }
    .order-summary p strong { color: #e5e2f3; }
    .order-summary .total { font-size: 1rem; color: #aca5db; margin-top: 0.5rem; }
    .order-summary .total-amount { color: #4ade80; font-weight: 700; font-size: 1.1rem; }
...
<div class="form-page">
    <div class="form-card">
        ...
        <div class="order-summary">
            ...
            <p class="total"><strong>Total Amount:</strong> <span class="total-amount">₱{{ number_format($order->total_amount, 2) }}</span></p>
        </div>
        ...
        <form action="{{ route('payments.store') }}" method="POST">
            ...
            <div class="form-group">
                <label>Amount (₱)</label>
                <input type="number" step="0.01" name="amount" value="{{ $order->total_amount }}" required>
            </div>
